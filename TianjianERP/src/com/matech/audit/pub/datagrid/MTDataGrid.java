 ...
 * @version 3.0
 */
public class MTDataGrid extends com.matech.framework.pub.datagrid.DataGrid {

	private DataGridProperty pp;

	public MTDataGrid(HttpSession session, HttpServletRequest request,
			HttpServletResponse response, DataGridProperty property) {
		super(session, request, response, property);
		this.pp = property;
	}
