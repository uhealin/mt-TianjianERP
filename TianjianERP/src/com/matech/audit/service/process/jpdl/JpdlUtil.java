...
public class JpdlUtil {
	...
	public static Point getRectangleLineCrossPoint(Rectangle rectangle,
		...
		rect.grow(grow, grow);
		Point p0 = JpdlUtil.getRectangleCenter(rect);
		...
		double slope = JpdlUtil.getSlope(p0.x, p0.y, rect.x, rect.y);
		double slopeLine = JpdlUtil.getSlope(p0.x, p0.y, p1.x, p1.y);
		double yIntercep = JpdlUtil.getYIntercep(p0.x, p0.y, p1.x, p1.y);
