...
public class _1038_0 extends AbstractAreaFunction {
...
//			}else
			...
			sql=""
				+" 	select \n" 
				+" 		sum(a.occurvalue) * ("+dt+") as occ,subjectname \n" 
				+"  from (\n"
				
				+"  	select subjectname1 as subjectname,subjectfullname1,occurvalue * dirction as occurvalue,vchdate \n"
				+" 		from c_subjectentry \n" 
				+" 		where accpackageid = "+apkID+" \n"
				...
				+"  	select b.subjectname,b.subjectfullname as subjectfullname1,a.occurvalue * dirction as occurvalue,vchdate \n"
				+"  	from   \n" 
				+"  	z_subjectentryrectify a  \n" 
				+"  	inner join   \n" 
				+"  	c_accpkgsubject b  \n" 
				...
				+"  ) a left join \n"
				+"  (    \n"
				+"                             select subjectname as gs from   \n" 
				+"                              (   \n" 
				+"                                select '工资' as subjectname  \n" 
				+"                                union select '薪金'   \n" 
				+"                                union select '福利'  \n" 
				+"                                union select '住房公积'  \n" 
				+"                                union select '退休保险'  \n" 
				...
				+"                                union select '无形资产'  \n" 
				+"                                union select '装修'  \n" 
				+"                                union select '报损存货处置收入'  \n" 
				+"                                union select '筹建'  \n" 
				+"                                union select '开办'  \n" 
				+"                              ) a   \n" 
				+"                              union  \n" 
				+"                              select TRIM(replace(replace(replace(replace(CONCAT(a.subjectname,'         '),b.key1,b.key2),c.key1,c.key2),d.key1,d.key2),'`',''))  \n" 
				+"                              from (  \n" 
				+"                                 select '工资' as subjectname  \n" 
				+"                                union select '薪金'   \n" 
				+"                                union select '福利'  \n" 
				...
				+"                              where a.subjectname like concat('%',b.key1,'%')  \n" 
