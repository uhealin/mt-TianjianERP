...
//是1035的扩展，支持去年等数据
public class _1047_0 extends AbstractAreaFunction {
...
//		
		...
		//更改1035的账套年份
		apkID=String.valueOf((Integer.parseInt(apkID)+Integer.parseInt(year)));
...
//			}else
			...
			sql=""
				...
				+"  	select subjectname1,occurvalue * dirction as occurvalue,vchdate \n"
				+" 		from c_subjectentry \n" 
				+" 		where accpackageid = "+apkID+" \n"
				...
				+"  	select b.subjectname as subjectname1,a.occurvalue * dirction as occurvalue,vchdate \n"
				+"  	from   \n" 
				+"  	z_subjectentryrectify a  \n" 
				+"  	inner join   \n" 
				+"  	c_accpkgsubject b  \n"  
