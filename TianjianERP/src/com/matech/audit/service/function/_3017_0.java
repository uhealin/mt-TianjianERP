...
/**
 *
 * <p>Title: 取余额明细记录的函数，供批量刷新调用，相当于原来的1017</p>
 * <p>Description:
 ...
 *    V、返回前N条参数：limit，如果没有设置，就按照默认5条返回；
 *      前台设置的方法为：
 *      =取列公式覆盖(3017, "", "subjectname","&subjectname=应收账款",10)
 * </p>
 *
...
public class _3017_0 extends AbstractAreaFunction {
...
//                args.put("allassitem","       and  \n       ( \n           asstotalname1 like '%客户%' \n           or asstotalname1 like '%供应商%' \n           or asstotalname1 like '%关联%' \n           or asstotalname1 like '%往来%' \n       ) \n");
            ...
            System.out.println("qwh:3007:resultSql="+resultSql);
            rs = st.executeQuery(resultSql);
...
/*
 ...
 on a2.accid=b2.accid
 order by sdbalance desc limit 5
*/
