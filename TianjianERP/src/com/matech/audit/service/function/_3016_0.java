...
public class _3016_0 extends AbstractAreaFunction {
...
//                 args.put("allassitem","       and  \n       ( \n           asstotalname1 like '%客户%' \n           or asstotalname1 like '%供应商%' \n      or asstotalname1 like '%关联%' \n        or asstotalname1 like '%往来%' \n       ) \n");
   ...
   public String getSql(String rectifySign,String subjectid){
	   return "" +
	   		...
	   		"\n	from  " +
	   		"\n	( " +
	   		"\n		select  subjectid,subjectfullname1,sum(if (subyearmonth*12+submonth=${EndYearMonth},balance * (${ptype}),0))  as balance,AccName" +
	   		"\n		from c_account  " +
