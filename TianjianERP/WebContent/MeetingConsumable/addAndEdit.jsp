				...
				<c:forEach var="list" items="${lists}" varStatus="vl">
					<tr>
						<td style="text-align: center;width:50%;" >
							<input type="text" id='names"${vl.count }"' name="names" value="${list.names }" class="data_tb_content" style="width:80%;text-align: center;">
						</td>
						<td style="text-align: center;width:10%;" >
							<input type="text" id='counts"${vl.count }"' name="counts" value="${list.counts }" class="data_tb_content" style="width:80%;text-align: center;">
						</td>
						<td style="text-align: center;width:20%;" >
							<input type="text" id='moneys"${vl.count }"' name="moneys" value="${list.moneys }" class="data_tb_content" style="width:80%;text-align: center;">
						</td>
						<td style="text-align: center;width:20%;" >
							<div style="text-align: center;" ><a href="#" class="a_href" onclick="f_remove(this)">【 删 除 】</a></div>
						</td>
					</tr>
				</c:forEach>
			</table>
...
<script type="text/javascript">
	...
	function addRow(){
	       ...
	       newTd2.innerHTML = "<div style='text-align: center;' ><input type='text' id='counts"+t+"' name='counts' style='width:80%;text-align: center;'  ></div>";
