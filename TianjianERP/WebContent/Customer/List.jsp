...
<div style="border-bottom:1px solid #AAAAAA; height: 1px;margin:0 20 4 20" ></div>
	<table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="">
     ...
     <tr>
      ...
      <td align=left><input name="departmentid1" type="text" id="departmentid1" value="" onKeyDown="onKeyDownEvent();" onKeyUp="onKeyUpEvent();"  onClick="onPopDivClick(this);" multilevel=true  valuemustexist="true" autoid=958 noinput=true  maxlength="20"></td>
