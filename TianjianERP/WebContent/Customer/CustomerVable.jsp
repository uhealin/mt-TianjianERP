...
<table border="0" cellpadding="0" cellspacing="0" bgcolor="" width="100%" align="center">
	<tr>
      <td align="right">分所/部门：</td>
      <td align=left>
        <input name="departmentid" type="text" id="departmentid" class="required"  onkeydown="onKeyDownEvent();" onkeyup="onKeyUpEvent();" onclick="onPopDivClick(this);" valuemustexist=true autoid=123 		noinput=true >
      </td>
   	</tr>
</table>
</div>
