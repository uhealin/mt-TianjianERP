...
<mt:DataGridPrintByBean name="headPassList"/>
</div>
<Script>
...
function goLook()
{
	if(document.getElementById("chooseValue_headPassList").value=="")
	{
		alert("请选择一项！");
		return ;
	}
	...
	{
		window.location="newCustomer.do?method=look&uuid="+document.getElementById("chooseValue_headPassList").value;
	}
}
