...
<center style="display: none;">
	<button onclick="save()">保存</button><button onclick="closeWin()">关闭</button>
</center>
</body>
<script type="text/javascript">
var editor ;
function save(){
	...
	form.action="${pageContext.request.contextPath}/declare.do?method=saveMorality";
