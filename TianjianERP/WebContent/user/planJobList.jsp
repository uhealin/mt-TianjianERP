...
//新增
function goAdd(){
	window.location="${pageContext.request.contextPath}/job.do?method=edit&table=k_job&flag=${flag}&rand="+Math.random()+"&who=planList";
}
...
function goEdit(){
	...
	if(id==""){
		...
		window.location="${pageContext.request.contextPath}/job.do?method=edit&table=k_job&flag=${flag}&unid="+id+"&rand="+Math.random();
	}
}
