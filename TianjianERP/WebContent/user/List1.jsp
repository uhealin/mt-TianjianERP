...
function goCPopedom(){
	...
	window.location="${pageContext.request.contextPath}/customer.do?method=userRight&userid="+document.getElementById("chooseValue_user").value;
}
...
function goMutiDelete1() {

	window.location="${pageContext.request.contextPath}/user.do?method=mutiDeleteList1";
}
