...
//新增
function goAdd(){
	window.location="${pageContext.request.contextPath}/job.do?method=edit&table=k_job&flag=list&rand="+Math.random()+"&who=role";
}
...
function goViewResume(){
	...
	if(id==""){
		...
		//
		var url="${pageContext.request.contextPath}/formDefine.do?method=formListView&uuid=52d67802-2c6b-48c9-ab5b-5f6b149e0d19&jobname="+id;
		//alert(url);
		window.location=url;
	}
} 
