		...
		<table width="90%" align="center" style="background-color: white;" class="table">
			...
			<tr>
				...
				<td class="td" colspan="4" nowrap="nowrap">
					<input type="hidden" name="addresseeId"  id="addresseeId"  value="${param.addresser}" >
					...
					<span style="margin-left: 15px"><a href="#" onclick="show_selectUser('addressee','addresseeId')">添加联系人</a> </span><br>
					...
					<div style="margin-left: 30px;margin-top: 6px;display: none;"> showDiv
			...
			<tr style="display: none;" id="1">
				...
				<td class="td" colspan="4" nowrap="nowrap">
					...
					<a href="#" onclick="show_selectUser('copyUser','copyUserId')">选人</a>
				</td>
			</tr>
			<tr style="display: none;" id="2">
				...
				<td class="td" colspan="4" nowrap="nowrap">
					...
					<a href="#" onclick="show_selectUser('secretUser','secretUserId')">选人</a>
				</td>
			</tr>
...
if("${email.addresser}" !="" || "${userIdAll}" !=""){
	show_getUser('addressee','addresseeId');
}
if("${copyUserId}"  !=""){
	show_getUser('copyUser','copyUserId');
}
if("${secretUserId}"  !=""){
	show_getUser('secretUser','secretUserId');
}
...
function showDiv(objDiv,obj,msg,obyText){
	...
	if(thisDiv.style.display =="none" ){
		...
		document.getElementById(obj).innerText = "取消"+msg;
	}else{
