...
<form id="thisForm" name="thisForm" action="" method="post">
	...
	<table class="data_tb"  align="center">
		<tr>
			<td class="data_tb_alignright" colspan="4">网络培训班资料</td>
		</tr>
		<tr>
			<td class="data_tb_alignright">培训班名称<span class="mustSpan">[*]</span>:</td>
			<td class="data_tb_content"><input class="required" id="name" name="name" type="text" value="${education.name }" title="请输入，不得为空"/></td>
			<td class="data_tb_alignright">课程类型</td>
			<td class="data_tb_content"><input class="required" id="courseType" name="courseType" type="text" value="${education.courseType }" title="请输入，不得为空" onKeyDown="onKeyDownEvent();" onKeyUp="onKeyUpEvent();" noinput="true" onClick="onPopDivClick(this);" autoid=3053/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="data_tb_alignright">网络培训班类型:</td>
		...
		<tr>
			...
			<td class="data_tb_content" colspan="3">
				<input type="hidden" name="attachment" id="attachment" value="${education.attachment}"/>
				<script type="text/javascript">
