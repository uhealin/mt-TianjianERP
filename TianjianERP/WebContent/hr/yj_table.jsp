...
<table class="formTable" style="width: 93%" >
  <tbody style="text-align: left;" >
    <tr>
       <th style="width: 100px" >姓名<font color="red">[*]</font></th>
       <td style="width: 210px"><input class="required" name="name_cn" value="${vo.name_cn }" /></td>
       <th style="width: 80px">性别<font color="red">[*]</font></th>
       <td style="width: 100px"><input id="sex" name="sex" value="${vo.sex }" autoid=700 refer="性别"  class="required"/></td>
       <th style="width: 80px">民族<font color="red">[*]</font></th>
    ...
    <tr>
       <th >家庭地址<font color="red">[*]</font></th>
       <td colspan="5"><input name="family_address" value="${vo.family_address }"  class="required"/></td>
    ...
    <tr>
        ...
        <th colspan="2">毕业年月<font color="red">[*]</font></th>
        <td><input name="grud_date" value="${vo.grud_date }" class="required"/></td>
    </tr>
    
     <tr>
        <th>学位</th>
        <td colspan="2"><input id="grud_degree" name="grud_degree" value="${vo.grud_degree }" autoid="700" refer="简历学位" /></td>
        <th colspan="2">辅修专业<font color="red">[*]</font></th>
        <td><input name="grud_pro_slave" value="${vo.grud_pro_slave }" class="required"/></td>
    </tr>
      
    <tr>
       <th rowspan="2">在班级或年</br>级成绩名次</th>
       <th>班级名次/总人数<font color="red">[*]</font></th>
       <td colspan="2" ><input name="class_postion" value="${vo.class_postion }" style="width: 40%" class="required validate-digits"/>
    ...
    <tr>
       <th>高考分/一本线分<font color="red">[*]</font></th>
       <td colspan="2" ><input name="cee_score" value="${vo.cee_score }" style="width: 40%" class="required validate-digits"/>/
        <input name="cee_line" value="${vo.cee_line }" style="width: 40%"/></td>
       <th colspan="2">高校录取批次<font color="red">[*]</font></th>
       <td  ><input id="cee_batch" name="cee_batch" value="${vo.cee_batch }" autoid="700" refer="简历院校" class="required"/></td>
    </tr>
    
    <tr>
       <th>英语等级</th>
       <td><input id="cee_level" name="cee_level" value="${cee_level }" autoid="700" refer="英语等级" /></td>
    ...
    <tr>
       <th>第二外语</th>
       <td><input  name="lang_info" value="${lang_info }" /></td>
    ...
    <tr>
       ...
       <td colspan="2"><input name="pe_height" value="${vo.pe_height }" class="required validate-number"/></td>
       <th colspan="2">体重(公斤)<font color="red">[*]</font></th>
    ...
    <th>婚否<font color="red">[*]</font></th>
       <td colspan="2"><input id="pe_marry" name="pe_marry" value="${vo.pe_marry }" autoid="700" refer="婚姻状况" class="required"/></td>
       <th colspan="2">期望薪资(年薪)<font color="red">[*]</font></th>
       <td ><input name="expect_payment" value="${vo.expect_payment }" class="required validate-number"></td>
       
    </tr>
    
    <tr>
      <th rowspan="5">学习简历<br/>(初中入学起)<font color="red">[*]</font></th>
      <th>何年何月-何年何月</th>
    ...
    <tr>
      ...
      <td colspan="5"><input name="edc_2_info" value="${vo.edc_2_info }" /></td>
            ...
            <td><input ext_type="date" id="edc_3_start_date" name="edc_1_start_date" value="${vo.edc_3_start_date }" style="width: 46%" />
     ...
     <tr>
      <th rowspan="5">社会实践经<br/>历（填写与求</br>职岗位相关</br>的实践经历，</br>天健的实习</br>经历必填)<font color="red">[*]</font></th>
      <th>何年何月-何年何月</th>
      <th colspan="5">单位/部门/岗位</th>
    </tr>
    
    <tr>
      <td><input ext_type="date" id="prac_1_start_date" name="prac_1_start_date" value="${vo.prac_1_start_date }" style="width: 46%" class="validate-date-cn-required"/>
      <input ext_type="date" id="prac_1_end_date" name="prac_1_end_date" value="${vo.prac_1_end_date }" style="width: 46%" class="validate-date-cn-required"/></td>
    ...
    <tr>
      ...
      <th>学校通讯地址<font color="red">[*]</font></th>
      <td colspan="5"><input name="address" value="${vo.address }" class="required"/></td>
    </tr>
    
    <tr>
      <th>E-mail<font color="red">[*]</font></th>
      <td colspan="3"><input name="email" value="${vo.email }" class="required"/></td>
      <th>邮编<font color="red">[*]</th>
      <td><input name="zipcode" value="${vo.zipcode }" class="required"/></td>
    </tr>
    
     <tr>
      <th>电话<font color="red">[*]</font></th>
      <td colspan="3"><input name="phone" value="${vo.phone }" class="validate-number"/></td>
      <th>手机<font color="red">[*]</font></th>
      <td><input name="mobile" value="${vo.mobile }" class="validate-number"/></td>
    </tr>
    
    <tr>
      <th>性格特长简述<font color="red">[*]</font></th>
      <td colspan="6"><textarea name="special_info"  class="validate-number">${vo.special_info}</textarea></td>
    </tr>
    ...
    <tr>
      ...
      <input readonly="readonly" name="apply_job_name" id="apply_job_name" value="${vo.apply_job_name}" onclick="show_selectJob('apply_job_name','apply_job_id','1')" /></td>
