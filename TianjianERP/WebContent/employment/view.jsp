...
<form method="post" id="thisForm" name="thisForm">
	...
	<table class="data_tb" align="center">
		...
		<tr>
			<td class="data_tb_content"><input type="text" id="chineseName" name="chineseName" class="required" title="请输入" value="${personal.chineseName }" style="border-style:none;border:0;border-bottom:1 solid blue;"/></td>
			<td class="data_tb_content"><input type="text" id="englishName" name="englishName" value="${personal.englishName }" style="border-style:none;border:0;border-bottom:1 solid blue;"/></td>
			...
			<td class="data_tb_content"><input type="text" id="place" name="place" value="${personal.place }" style="border-style:none;border:0;border-bottom:1 solid blue;"/></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="data_tb_content" colspan="2"><input type="text" id="nowWorkPlace" name="nowWorkPlace" value="${personal.nowWorkPlace }" style="border-style:none;border:0;border-bottom:1 solid blue;" size="40"/></td>
			<td class="data_tb_content"><input type="text" id="nation" name="nation" value="${personal.nation }" style="border-style:none;border:0;border-bottom:1 solid blue;"/></td>
			<td class="data_tb_content"><input type="text" id="degree" name="degree" value="${personal.degree }" onkeydown="onKeyDownEvent();" onkeyup="onKeyUpEvent();" onclick="onPopDivClick(this);" valuemustexist=true noinput=true autoid=3056 style="border-style:none;border:0;border-bottom:1 solid blue;"/></td>
			<td class="data_tb_content"><input type="text" id="residence" name="residence" value="${personal.residence }" style="border-style:none;border:0;border-bottom:1 solid blue;"/></td>
		...
		<tr>
			<td class="data_tb_content"><input type="text" id="mobile" name="mobile" value="${personal.mobile }" style="border-style:none;border:0;border-bottom:1 solid blue;"/></td>
			<td class="data_tb_content"><input type="text" id="passport" name="passport" value="${personal.passport }" style="border-style:none;border:0;border-bottom:1 solid blue;"/></td>
			<td class="data_tb_content"><input type="text" id="idNo" name="idNo" value="${personal.idNo }" class="required" title="请输入" style="border-style:none;border:0;border-bottom:1 solid blue;"/></td>
			<td class="data_tb_content" colspan="2"><input type="text" id="email" name="email" value="${personal.email }" style="border-style:none;border:0;border-bottom:1 solid blue;" size="40"/></td>
			<td class="data_tb_content"><input type="text" id="qualifications" name="qualifications" value="${personal.qualifications }" style="border-style:none;border:0;border-bottom:1 solid blue;"/></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="6" class="data_tb_content">
				<input class="data_tb_content" id="relationships" name="relationships" value="${personal.relationships}" style="border-style:none;border:0;border-bottom:1 solid blue;" size="150"/>
			</td>
		</tr>
		<tr>
			<td colspan="6">
...
function goNext(){
	...
	window.location="employment.do?method=lookResume&linkUserId="+linkUserId;
}
</script>
</html>