...
<mt:DataGridPrintByBean name="stateDatagird"/>
</div>
...
<script type="text/javascript">
function goLook(){
	var choose = getChooseValue("stateDatagird");
	if(choose == ""){
		alert("请选择要修改状态的简历！");
...
function distributionResume(){
	...
	window.location="employment.do?method=addDistribution&&id="+choose+"&&userId="+userId+"&&act=stateDatagird";
}
