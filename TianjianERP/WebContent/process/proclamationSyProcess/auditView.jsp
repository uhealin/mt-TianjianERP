...
<body>
	<div style="overflow: auto;height: 100%;border: 0px;">
	<center>
		<div align="right" class="title" style="background-color: d3e1f1" ><b>${proclamation.title }</b></div>
	</center>
		<div align="right" class="publish" style="background-color: #6595d6">
