	...
	renderTo:'divBtn',
       items:[ {
			...
			handler:function checkFlowsheet() {
				var id = getChooseValue("organizationAuditList");
				if(id == "") {
			...
			text:'刷新',
	   		icon:'${pageContext.request.contextPath}/img/refresh.gif',
	   		 handler:function(){
	   			empty();
	   			goSearch_organizationAuditList();
	   		 }
		}  ]
    });  
...
<body >
		...
		<div style="height:expression(document.body.clientHeight-28);" >
			<mt:DataGridPrintByBean name="organizationAuditList" />
		</div>
...
new Ext.form.DateField({			
 ...
 function goAudit(){
	 	...
	 	var uuids = getChooseValue("organizationAuditList");
