...
function ext_init(){ 
	var tbar_policy = new Ext.Toolbar({
		...
		items:[{
			...
			handler:function () {
				window.self.location='/AuditSystem/oa/practicalbalance/rdGetFundsEdit.jsp';
			}
		},'-',{
           text:'修改',
...
function goEdit(){
	...
	{
		window.location="getFunds.do?method=rdGetGetFundsById&autoid="+document.getElementById("chooseValue_GetFundsList").value;
	}
}
