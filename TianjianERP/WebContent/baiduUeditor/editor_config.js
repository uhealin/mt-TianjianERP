...
(function () {
    ...
    UEDITOR_CONFIG = {
        ...
        iframeUrlMap:{
            'anchor':'~/baiduUeditor/dialogs/anchor/anchor.html',
            'insertimage':'~/baiduUeditor/dialogs/image/image.html',
            'inserttable':'~/baiduUeditor/dialogs/table/table.html',
            'link':'~/baiduUeditor/dialogs/link/link.html',
            'spechars':'~/baiduUeditor/dialogs/spechars/spechars.html',
            'searchreplace':'~/baiduUeditor/dialogs/searchreplace/searchreplace.html',
            'map':'~/baiduUeditor/dialogs/map/map.html',
            'gmap':'~/baiduUeditor/dialogs/gmap/gmap.html',
            'insertvideo':'~/baiduUeditor/dialogs/video/video.html',
            'help':'~/baiduUeditor/dialogs/help/help.html',
            'highlightcode':'~/baiduUeditor/dialogs/code/code.html',
            'emotion':'~/baiduUeditor/dialogs/emotion/emotion.html',
            'wordimage':'~/baiduUeditor/dialogs/wordimage/wordimage.html',
            'attachment':'~/baiduUeditor/dialogs/attachment/attachment.html',
            'insertframe':'~/baiduUeditor/dialogs/insertframe/insertframe.html',
            'edittd':'~/baiduUeditor/dialogs/table/edittd.html',
            'snapscreen': '~/baiduUeditor/dialogs/snapscreen/snapscreen.html'
        },
        //所有的的下拉框显示的内容
        listMap:{
            //字体
        ...
        snapscreenServerFile: URL +"baiduAdmin/server/upload/imageUp.jsp", //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
