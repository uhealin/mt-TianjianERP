...
function makeRaised(el) {
	...
	if(!el.disabled) {
		with (el.style) {
			...
			border = "1px solid #7495D8";
			padding      = "1px";
			
			backgroundColor = "#C6D3EF";
		}
	}
}
...
document.write(".coolButton {border: 1px solid buttonface;font-size: 12px; padding: 1px; text-align: center; cursor: hand;}");
