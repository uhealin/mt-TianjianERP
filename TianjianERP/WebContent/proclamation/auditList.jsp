...
function goAudit(){
	...
	{
		window.location="${pageContext.request.contextPath}/proclamation.do?method=auditSkip&taskId="+taskId;
	}
}
...
function goLook(){
 	...
 	if(uuids=="" || uuids==null){
		...
		return;
		 ...
		 window.location = "${pageContext.request.contextPath}/proclamation.do?method=look&uuid="+uuids;
